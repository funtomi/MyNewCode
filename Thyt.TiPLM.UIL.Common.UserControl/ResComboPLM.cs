...
{
    public class ResComboPLM : PopupContainerEditPLM
    {
        ...
        public ResComboPLM(IContainer container)
        {
            this.comColumn = "选_中";
            this.i_PageSearchNum = 0x1388;
            this.IsFromEdit = true;
        ...
        public ResComboPLM(Guid classOid, DEMetaAttribute metaAttr) : this()
        {
        ...
        public ResComboPLM(string clsName, DEMetaAttribute metaAttr) : this()
        {
        ...
        public ResComboPLM(Guid classOid, DEMetaAttribute metaAttr, Hashtable ht_param) : this()
        {
        ...
        public ResComboPLM(string clsName, DEMetaAttribute metaAttr, Hashtable ht_param) : this()
        {
            this.Ht_resParam = ht_param;
            this.className = clsName;
            DEMetaClass class2 = ModelContext.MetaModel.GetClass(clsName);
        ...
        public ResComboPLM(Guid classOid, DEMetaAttribute metaAttr, Hashtable ht_param, bool AllowLike) : this()
        {
        ...
        public ResComboPLM(string clsName, DEMetaAttribute metaAttr, Hashtable ht_param, bool AllowLike) : this()
        {
            this.b_AllowLike = AllowLike;
            this.Ht_resParam = ht_param;
            this.className = clsName;
        ...
        private void InitializeConfig()
        {
            ...
            this.QueryPopUp += new CancelEventHandler(this.ResComboPLM_QueryPopUp);
            this.AllowDrop = true;
        ...
        private void ResCombo_KeyDown(object sender, KeyEventArgs e)
        {
            this.Dt_ClickStart = DateTime.Now;
            this.Dt_ClickEnd = DateTime.Now;
            if ((this.DenyWriteByHand && !this.deMetaAttri.IsListInDomain) && (!this.b_ReadOnly && (e.KeyCode == Keys.Delete)))
            {
                this.Text = "";
            }
        }
        ...
        private void ResCombo_Resize(object sender, EventArgs e)
        {
            ...
            {
                this.ucUser.Width = base.Width;
                base.Properties.PopupControl.Width = this.ucUser.Width;
            }
        }
        ...
        private void ResComboPLM_QueryPopUp(object sender, CancelEventArgs e)
        {
        ...
        {
            get{
               return this.Text.TrimEnd(new char[0]);
            }set
            {
                this.Text = value;
            }
