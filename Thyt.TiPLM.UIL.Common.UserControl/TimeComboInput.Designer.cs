namespace Thyt.TiPLM.UIL.Common.UserControl {
    partial class TimeComboInput {
        ...
        private void InitializeComponent() {
            Infragistics.Win.UltraWinEditors.DropDownEditorButton button = new Infragistics.Win.UltraWinEditors.DropDownEditorButton("SelectTime") {
